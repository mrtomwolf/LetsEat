package com.tomasforsman.letseat.world.gen.generators;
...
{
	public static final IBlockState LOG = ModBlocks.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.ALUMINIUM);
	public static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumType.ALUMINIUM);
	//public static final IBlockState SAPLING = ModBlocks.SAPLINGS.getDefaultState().withProperty(BlockSaplings.VARIANT, EnumHandler.EnumType.ALUMINIUM);
