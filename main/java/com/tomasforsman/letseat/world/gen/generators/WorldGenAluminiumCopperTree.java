...
public class WorldGenAluminiumCopperTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.COPPER);
	public static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumType.ALUMINIUMCOPPER);
	
	private final int minHeight;
	
	public WorldGenAluminiumCopperTree() 
	{
		super(false);
		this.minHeight = 30;
	}
