package com.tomasforsman.letseat.world.gen;

import java.util.Random;

import com.tomasforsman.letseat.init.ModBlocks;
import com.tomasforsman.letseat.blocks.BlockOres;
import com.tomasforsman.letseat.util.handlers.EnumHandler;
...
public class WorldGenCustomOres implements IWorldGenerator
{
	...
	public WorldGenCustomOres() 
	{
		...
		ore_nether_aluminium = new WorldGenMinable(ModBlocks.ORE_NETHER.getDefaultState().withProperty(BlockOres.VARIANT, EnumHandler.EnumType.ALUMINIUM), 9, BlockMatcher.forBlock(Blocks.NETHERRACK));
		ore_overworld_aluminium = new WorldGenMinable(ModBlocks.ORE_OVERWORLD.getDefaultState().withProperty(BlockOres.VARIANT, EnumHandler.EnumType.ALUMINIUM), 9, BlockMatcher.forBlock(Blocks.STONE));
		ore_end_aluminium = new WorldGenMinable(ModBlocks.ORE_END.getDefaultState().withProperty(BlockOres.VARIANT, EnumHandler.EnumType.ALUMINIUM), 9, BlockMatcher.forBlock(Blocks.END_STONE));
	}
