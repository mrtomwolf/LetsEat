...
public class WorldGenCustomTrees implements IWorldGenerator
{
	...
	private final WorldGenerator ALUMINIUMCOPPER = new WorldGenAluminiumCopperTree();
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 0:
			...
			runGenerator(ALUMINIUMCOPPER, world, random, chunkX, chunkZ, 3, -1, 0, BiomeForest.class);
