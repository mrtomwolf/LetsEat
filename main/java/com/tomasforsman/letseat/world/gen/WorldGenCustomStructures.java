...
import com.tomasforsman.letseat.world.gen.generators.WorldGenStructure;
...
public class WorldGenCustomStructures implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 0:
			...
			generateStructure(ARMOURY, world, random, chunkX, chunkZ, 20, ModBlocks.DIRT, BiomeCopper.class);
			runGenerator(COPPER, world, random, chunkX, chunkZ, 5, ModBlocks.DIRT, BiomeCopper.class);
