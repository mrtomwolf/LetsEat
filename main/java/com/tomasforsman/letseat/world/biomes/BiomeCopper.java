package com.tomasforsman.letseat.world.biomes;
...
public class BiomeCopper extends Biome 
{
	...
	public BiomeCopper() 
	{
		...
		topBlock = ModBlocks.DIRT.getDefaultState().withProperty(BlockDirts.VARIANT, EnumHandler.EnumType.COPPER);
		fillerBlock = ModBlocks.ORE_OVERWORLD.getDefaultState().withProperty(BlockOres.VARIANT, EnumHandler.EnumType.COPPER);
