...
public class ChunkGeneratorLibrary implements IChunkGenerator
{
    ...
    protected static final IBlockState OTHER_BLOCK2 = ModBlocks.BLOCK_COPPER.getDefaultState();
    ...
    */
    ...
    public ChunkGeneratorLibrary(World world, boolean generate, long seed)
    {
        this.world = world;
